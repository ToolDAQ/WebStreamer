...
SOURCEFILES:=$(patsubst %.cpp, %.o, $(filter-out $(AlreadyCompiled), $(wildcard DataModel/*.cpp) $(wildcard UserTools/*/*.cpp) $(wildcard src/*.cpp)))
