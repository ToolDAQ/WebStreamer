...
/**
 * \struct FakeDataSource_args_args
 *
...
struct FakeDataSource_args:Thread_args{
...
class FakeDataSource: public Tool {


 public:

  FakeDataSource(); ///< Simple constructor
 ...
 private:
  ...
  FakeDataSource_args* args; ///< thread args (also holds pointer to the thread)
